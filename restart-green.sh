...
#docker run -it --rm --network="host" --env-file /home/debian/docker/fastapi-text2sql-green/.env -v $(pwd):/app -v "$LOGS_DIR":/app/logs -v "$UPLOADS_DIR":/app/uploads --name fastapi-text2sql-green fastapi-text2sql-green-app
docker run -d --rm --network="host" --env-file /home/debian/docker/fastapi-text2sql-green/.env -v $(pwd):/app -v "$LOGS_DIR":/app/logs -v "$UPLOADS_DIR":/app/uploads --name fastapi-text2sql-green fastapi-text2sql-green-app
