...
#### Movies – return:
ID_MOVIE, MOVIE_TITLE, DAT_RELEASE, ID_IMDB, IMDB_RATING, IMDB_RATING_ADJUSTED, POSTER_PATH 

### Series - return:
ID_SERIE, SERIE_TITLE, DAT_FIRST_AIR, DAT_LAST_AIR, ID_IMDB, IMDB_RATING, IMDB_RATING_ADJUSTED, POSTER_PATH

### Movies AND Series (UNION) - return for a movie and for a serie:
ID_MOVIE AS ID_CONTENT, 'movie' AS CONTENT_TYPE, MOVIE_TITLE AS CONTENT_TITLE, DAT_RELEASE AS DAT_FIRST_AIR, DAT_RELEASE AS DAT_LAST_AIR, ID_IMDB, IMDB_RATING, IMDB_RATING_ADJUSTED, POSTER_PATH 
ID_SERIE AS ID_CONTENT, 'serie' AS CONTENT_TYPE, SERIE_TITLE AS CONTENT_TITLE, DAT_FIRST_AIR, DAT_LAST_AIR, ID_IMDB, IMDB_RATING, IMDB_RATING_ADJUSTED, POSTER_PATH
...
- Collections → IMDB_RATING_ADJUSTED DESC
...
- Movements → IMDB_RATING_ADJUSTED DESC
...
- Awards for a movie or serie → IMDB_RATING_ADJUSTED DESC
...
- Nominations for a movie or serie → IMDB_RATING_ADJUSTED DESC
...
- Topics → IMDB_RATING_ADJUSTED DESC
- Lists → IMDB_RATING_ADJUSTED DESC
- Collections → IMDB_RATING_ADJUSTED DESC
- Movements → IMDB_RATING_ADJUSTED DESC
- Groups → POPULARITY DESC
- Deaths → POPULARITY DESC
- Awards → IMDB_RATING_ADJUSTED DESC
- Nominations → IMDB_RATING_ADJUSTED DESC
