...
--
-- Hôte : mariadb
-- Généré le : dim. 10 mai 2026 à 12:51
...
ALTER TABLE `T_WC_T2S_PERSON_MOVIE`
  ...
  ADD KEY `IDX_T2S_PERSON_MOVIE_CASTKEY_MOVIE` (`CREDIT_TYPE`,`DELETED`,`CAST_CHARACTER_KEY`,`ID_MOVIE`,`DISPLAY_ORDER`),
  ADD KEY `IDX_T2S_PERSON_MOVIE_CASTKEY_PERSON` (`CREDIT_TYPE`,`DELETED`,`CAST_CHARACTER_KEY`,`ID_PERSON`,`DISPLAY_ORDER`);
...
ALTER TABLE `T_WC_T2S_PERSON_SERIE`
  ...
  ADD KEY `CREW_DEPARTMENT` (`CREW_DEPARTMENT`),
  ADD KEY `CREW_JOB` (`CREW_JOB`),
  ADD KEY `IDX_T2S_PERSON_SERIE_CASTKEY_SERIE` (`CREDIT_TYPE`,`DELETED`,`CAST_CHARACTER_KEY`,`ID_SERIE`,`DISPLAY_ORDER`),
  ADD KEY `IDX_T2S_PERSON_SERIE_CASTKEY_PERSON` (`CREDIT_TYPE`,`DELETED`,`CAST_CHARACTER_KEY`,`ID_PERSON`,`DISPLAY_ORDER`);
